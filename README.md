...
- [**Food Restaurant Automated Workflow**](https://github.com/SalaamRasak/AI_Automation_Workflow): This workflow uses a custom form built using HTML5, CSS3, and JavaScript.  using Make.com, Telegram Bot, Google API, and Gmail.
